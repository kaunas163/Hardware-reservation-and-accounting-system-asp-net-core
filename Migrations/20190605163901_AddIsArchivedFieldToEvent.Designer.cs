...
namespace HardwareReservationAndAccountingSystem.Migrations
{
    ...
    [Migration("20190605163901_AddIsArchivedFieldToEvent")]
    partial class AddIsArchivedFieldToEvent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HardwareReservationAndAccountingSystem.Models.EquipmentsInBundles", b =>
                {
                    b.Property<int>("EquipmentsInBundlesId");

                    b.Property<int>("EquipmentId");

                    b.Property<int>("EquipmentBundleId");

                    b.HasKey("EquipmentsInBundlesId", "EquipmentId", "EquipmentBundleId");
            ...
            modelBuilder.Entity("HardwareReservationAndAccountingSystem.Models.Notification", b =>
                {
                    ...
                    b.HasOne("HardwareReservationAndAccountingSystem.Models.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HardwareReservationAndAccountingSystem.Models.ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
